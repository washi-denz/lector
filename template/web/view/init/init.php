		...
		<div class="container mx-auto lg:px-32">
			<form id="formEnviarRespuestas">
				...
				<div class="lg:mx-40 md:mx-8 sm:mx-16 bg-yellow-300 rounded-md shadow-md text-center p-3 mx-3 mb-8">
					...
					<label class="text-yellow-600 font-medium text-lg mb-2">Su nombre:</label>
					
					<select class="focus:outline-none border-4 border-yellow-400 rounded-sm px-3 py-2 mx-auto mb-8 w-full md:w-auto block" name="id_alumno">
